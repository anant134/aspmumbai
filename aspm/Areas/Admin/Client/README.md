...
1. Home page banner Add/update/delete
2. News & Events, Notice board, Download & Vacancies Add/update/delete
3. Our staff Add/update/delete
4. Facilities categories wise Add/update/delete
5. NCERT Add/update/delete pdf
6. AWES Book Add/update/delete pdf
7. E-magazine Add/update/delete pdf
8. Photo gallery Add/update/delete
9. Video Add/update/delete
10. TC Add/update/delete
11. Fee structure Add/update/delete
12. Contact us enquiry form should be save in database and email sent to admin email id
